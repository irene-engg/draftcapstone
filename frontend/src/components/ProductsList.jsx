	...
	return (
		...
		>
			<table className=' min-w-full divide-y divide-black '>
				...
				<tbody className='bg-[#ffff] divide-y divide-black'>
					{products?.map((product) => (
						<tr key={product._id} className='hover:bg-[#f5f5f5]'>
							...
							<td className='px-6 py-4 whitespace-nowrap'>
								<button
									...
									className={`p-1 rounded-full ${
										product.isFeatured ? "bg-yellow-400 text-gray-900" : "bg-[#f5f5f5] text-black"
